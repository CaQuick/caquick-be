...
| Category                | Keys                                                                                                                                                                                                                                                                                               |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Server**              | `NODE_ENV`, `PORT`, `BACKEND_BASE_URL`, `FRONTEND_BASE_URL` (comma-separated list; every entry becomes a non-production CORS origin and the first entry is the default post-login redirect), `APP_ROLE` (`api`, `ws`, `worker`; default `api`), `TRUST_PROXY_HOPS`                                 |
...
| **OIDC**                | `OIDC_GOOGLE_CLIENT_ID`, `OIDC_GOOGLE_CLIENT_SECRET`, `OIDC_GOOGLE_ISSUER_URL`, `OIDC_KAKAO_CLIENT_ID`, `OIDC_KAKAO_CLIENT_SECRET`, `OIDC_KAKAO_ISSUER_URL`, `OIDC_TEMP_COOKIE_MAX_AGE_MS`                                                                                                         |
