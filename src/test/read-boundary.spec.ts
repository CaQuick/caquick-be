...
const CROSS_READ_ALLOWLIST: string[] = [
  'src/features/admin/repositories/admin.repository.ts|filter|Account.store->Store',
  ...
  'src/features/admin/repositories/admin.repository.ts|opaque|createSellerAccount:SellerProfile.data=args.profile',
  'src/features/admin/repositories/admin.repository.ts|opaque|createSellerAccount:Store.data=args.store',
  'src/features/admin/repositories/admin.repository.ts|opaque|resolvePendingReportsTx:ReviewReport.where=targetWhere',
  ...
  'src/features/product/repositories/product-review.repository.ts|filter|Review.product->Product',
  'src/features/product/repositories/product-review.repository.ts|filter|Review.store->Store',
  ...
  'src/features/seller/repositories/seller.repository.ts|opaque|updateFaqTopic:StoreFaqTopic.data=args.data',
  'src/features/seller/repositories/seller.repository.ts|opaque|updateStore:Store.data=args.data',
  ...
  'src/features/user/repositories/user.repository.ts|filter|WishlistItem.product->Product',
  'src/features/user/repositories/user.repository.ts|filter|WishlistItem.product.store->Store',
