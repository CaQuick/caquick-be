...
/**
 * ws 연결의 인증 토큰은 connectionParams.authorization으로 들어오므로, upgrade 요청 객체에 HTTP 헤더 형태로
 * 이식해 기존 JwtAuthGuard/passport 경로(req.headers.authorization)를 그대로 태운다 — 가드 이원화 방지.
 */
