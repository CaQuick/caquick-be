...
import { MyWishlistStoreGroupsInput } from '@/features/mypage/dto/inputs/my-wishlist-store-groups.input';
import { MyWishlistInput } from '@/features/mypage/dto/inputs/my-wishlist.input';
