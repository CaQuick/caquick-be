...
import type { MyWishlistStoreGroupsInput } from '@/features/mypage/dto/inputs/my-wishlist-store-groups.input';
import type { MyWishlistInput } from '@/features/mypage/dto/inputs/my-wishlist.input';
import type {
  MyWishlistConnection,
  MyWishlistStoreGroupsConnection,
} from '@/features/mypage/types/mypage-wishlist-output.type';
