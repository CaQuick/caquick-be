...
import type { MyRecentViewedProductsInput } from '@/features/mypage/dto/inputs/my-recent-viewed-products.input';
import type { RecentViewedProductConnection } from '@/features/mypage/types/mypage-overview-output.type';
