...
import type { AdminSetStoreActiveInput } from '@/features/store/dto/inputs/admin-set-store-active.input';
import type { AdminStoreListInput } from '@/features/store/dto/inputs/admin-store-list.input';
...
export class AdminStoreService extends AdminBaseService {
  constructor(
    ...
    protected readonly repo: StoreAdminRepository,
