...
import type { AdminCategoryListInput } from '@/features/product/dto/inputs/admin-category-list.input';
import type { AdminCreateCategoryInput } from '@/features/product/dto/inputs/admin-create-category.input';
import type { AdminCreateTagInput } from '@/features/product/dto/inputs/admin-create-tag.input';
import type { AdminTagListInput } from '@/features/product/dto/inputs/admin-tag-list.input';
import type { AdminUpdateCategoryInput } from '@/features/product/dto/inputs/admin-update-category.input';
import type { AdminUpdateTagInput } from '@/features/product/dto/inputs/admin-update-tag.input';
import { ProductAdminRepository } from '@/features/product/repositories/product-admin.repository';
import {
  toAdminCategoryOutput,
  toAdminTagOutput,
} from '@/features/product/services/product-admin-taxonomy-mappers.helper';
import type {
  AdminCategoryOutput,
  AdminTagOutput,
