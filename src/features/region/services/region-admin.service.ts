...
import { MAX_REGION_NAME_LENGTH } from '@/features/region/constants/region.constants';
import type { AdminCreateRegionInput } from '@/features/region/dto/inputs/admin-create-region.input';
import type { AdminRegionListInput } from '@/features/region/dto/inputs/admin-region-list.input';
import type { AdminUpdateRegionInput } from '@/features/region/dto/inputs/admin-update-region.input';
import {
  RegionAdminRepository,
  type AdminRegionRow,
} from '@/features/region/repositories/region-admin.repository';
import { toAdminRegionOutput } from '@/features/region/services/region-admin-mappers.helper';
...
export class AdminRegionService extends AdminBaseService {
  constructor(
    ...
    protected readonly repo: RegionAdminRepository,
  ) {
